(function()
{
    return function()
    {
        ...
        {
            // properties
            this.set_id("userProject");
            this.set_version("");
            this.set_tracemode("none");
            this.set_themeid("userProject.xtheme");
            ...
            mainframe.set_titletext("NEXA CRUD PROJECT");
        ...
        // script Compiler
        this.registerScript("userProject.xadl", function(exports) {
        //Application Script
        ...
        this.loadScreenInfo();
        this.loadTheme("userProject.xtheme");

this.loadCss("Css::userProject.css");
this.loadCss("Css::userProjectMdi.css");

        this.loadIncludeScript("userProject.xadl", true);
    };
}
)();
