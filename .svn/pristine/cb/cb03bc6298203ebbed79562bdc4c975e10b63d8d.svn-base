(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edt_SpntNm", "absolute", "133", "52", "251", "20", null, null, this);
            obj.set_taborder("17");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"117\"/><Column size=\"85\"/><Column size=\"133\"/><Column size=\"111\"/><Column size=\"93\"/><Column size=\"40\"/></Columns><Rows><Row size=\"24\" band=\"head\"/></Rows><Band id=\"head\"><Cell text=\"교육사업관리번호\"/><Cell col=\"1\" text=\"교육사업명\"/><Cell col=\"2\" text=\"교육사업기관명\"/><Cell col=\"3\" text=\"사업주관기관명\"/><Cell col=\"4\" text=\"사업내용\"/><Cell col=\"5\" text=\"사업담당자\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_text("<fc v='red'>*</fc>기관형태구분");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("48");
            obj.set_text("<fc v='red'>*</fc>교육구분");
            obj.set_cssclass("basic_sta_block");
            obj.getSetter("class").set("sta_WADA_label");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "432", "447", "149", "22", null, null, this);
            obj.set_taborder("50");
            ...
            obj = new Edit("Edit03", "absolute", "582", "484", "170", "22", null, null, this);
            obj.set_taborder("51");
            ...
            obj = new Static("Static29", "absolute", "432", "484", "149", "22", null, null, this);
            obj.set_taborder("55");
            ...
            obj = new Calendar("Calendar03", "absolute", "583", "447", "169", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("56");
            ...
            obj.set_taborder("60");
            obj.set_text("사업담당자이메일");
            obj.set_cssclass("basic_sta_block");
            obj.getSetter("class").set("sta_WADA_label");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Static("Static33", "absolute", "431", "522", "149", "22", null, null, this);
            obj.set_taborder("62");
            obj.set_text("수정일시");
            obj.set_cssclass("basic_sta_block");
            obj.getSetter("class").set("sta_WADA_label");
            ...
            obj = new Static("Static36", "absolute", "431", "561", "149", "22", null, null, this);
            obj.set_taborder("67");
            obj.set_text("수정자사번");
            obj.set_cssclass("basic_sta_block");
            obj.getSetter("class").set("sta_WADA_label");
            ...
            obj = new Edit("Edit07", "absolute", "583", "560", "170", "22", null, null, this);
            obj.set_taborder("75");
            obj.set_cssclass("input_must");
            ...
            obj.set_taborder("80");
            obj.set_text("<fc v='red'>*</fc>사업시작일자");
            obj.set_usedecorate("true");
            obj.set_cssclass("basic_sta_block");
            obj.getSetter("class").set("sta_WADA_label");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("Calendar00", "absolute", "583", "522", "169", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("90");
            obj.set_dateformat("yyyy.MM.dd");
            obj.set_editformat("yyyy.MM.dd");
            ...
            obj = new Edit("Edit00", "absolute", "157", "486", "270", "22", null, null, this);
            obj.set_taborder("91");
            obj.set_cssclass("input_must");
            obj.style.set_border("2 none #f79a00ff");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("Eclst0001.xfdl", "Lib::Comm.xjs");
        this.registerScript("Eclst0001.xfdl", function(exports) {
        /***********************************************************************************
        * SYSTEM      : 넥사크로플랫폼 
        * BUSINESS    : 샘플화면-교육용
        * FILE NAME   : 
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("Eclst0001.xfdl", true);
