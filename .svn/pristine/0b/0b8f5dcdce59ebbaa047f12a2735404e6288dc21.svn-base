    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,784,60);
            }
            this.style.set_background("goldenrod");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 784, 60, this,
            	//-- Layout function
            	function(p) {
            		p.style.set_background("goldenrod");
        ...
        // User Script
        this.addIncludeScript("tabFrame.xfdl", "Lib::Comm.xjs");
