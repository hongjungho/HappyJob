(function()
{
    return function()
    {
        ...
        this.on_initApplication = function()
        {
            ...
            // frame
            var mainframe = this.createMainFrame("mainframe", "absolute", "0", "0", "1200", "700", null, null, this);
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            var frame1 = new HFrameSet("HFrameSet", "absolute", null, null, null, null, null, null, frame0);
            frame0.addChild(frame1.name, frame1);
            frame1.set_separatesize("0,*");
            frame1.set_showtitleicon("false");

            var frame2 = new VFrameSet("VFrameSet1", "absolute", null, null, null, null, null, null, frame1);
            frame1.addChild(frame2.name, frame2);
            frame2.set_separatesize("30,*");
            ...
            var frame4 = new FrameSet("WorkFrame", "absolute", null, null, null, null, null, null, frame2);
            frame2.addChild(frame4.name, frame4);

            
            var frame5 = new ChildFrame("Main", "absolute", null, null, null, null, null, null, "Frame::MainFrame.xfdl", frame4);
            frame4.addChild(frame5.name, frame5);
            frame5.set_formurl("Frame::MainFrame.xfdl");
            frame5.set_showcascadestatustext("false");
            frame5.set_showcascadetitletext("false");
            frame5.set_showtitlebar("false");
            frame5.set_showtitleicon("false");

            var frame6 = new ChildFrame("MDIFrame", "absolute", null, null, null, null, null, null, "Frame::TopFrameLib.xfdl", frame0);
            frame0.addChild(frame6.name, frame6);
            frame6.set_formurl("Frame::TopFrameLib.xfdl");
        ...
        // script Compiler
        this.registerScript("HappyLib.xadl", function(exports) {
        //Application Script
        ...
        this.loadIncludeScript("HappyLib.xadl", true);
    };
}
)();
