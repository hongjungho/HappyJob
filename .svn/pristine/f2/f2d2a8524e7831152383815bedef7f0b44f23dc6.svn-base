(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("15");
            obj.set_text("전화번호 인증을 하기 위해서는\r\n등록된 정보(전화번호)과 입력한 정보가 동일해야, 아이디를 받을 수 있습니다.");
        ...
        // User Script
        this.addIncludeScript("find_ID_tel.xfdl", "Lib::Comm.xjs");
        this.registerScript("find_ID_tel.xfdl", function(exports) {
        /***********************************************************************************
        * SYSTEM      : UserProject
        ...
        */
        ...
        this.loadIncludeScript("find_ID_tel.xfdl", true);
