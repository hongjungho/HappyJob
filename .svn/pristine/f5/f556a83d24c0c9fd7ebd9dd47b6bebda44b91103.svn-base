(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Layout("default", "", 200, 215, this.div_left.Div01,
            	...
            	function(p) {
            		p.set_taborder("4");
            		p.set_text("Div01");
            		p.style.set_background("#ff99ccff");
        ...
        // User Script
        this.addIncludeScript("LeftFrame_3.xfdl", "Lib::Comm.xjs");
        this.registerScript("LeftFrame_3.xfdl", function(exports) {
        ...
        this.loadIncludeScript("LeftFrame_3.xfdl", true);
