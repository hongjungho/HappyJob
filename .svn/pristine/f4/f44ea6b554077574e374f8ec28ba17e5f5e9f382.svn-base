    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FrmtnCourse0001");
                this.set_titletext("편성교육과목내역");
            ...
            obj = new Static("Static26", "absolute", "0", "92", "146", "20", null, null, this);
            obj.set_taborder("2");
            obj.set_text("편성교육과목 목록");
            ...
            obj = new Static("Static28", "absolute", "3", "52", "117", "22", null, null, this);
            obj.set_taborder("12");
            ...
            obj = new Static("Static24", "absolute", "434", "373", "149", "22", null, null, this);
            obj.set_taborder("50");
            ...
            obj = new Calendar("Calendar03", "absolute", "585", "373", "169", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("56");
            ...
            obj = new Static("Static33", "absolute", "433", "448", "149", "22", null, null, this);
            obj.set_taborder("62");
            obj.set_text("수정일시");
            obj.set_cssclass("basic_sta_block");
            obj.getSetter("class").set("sta_WADA_label");
            ...
            obj = new Static("Static36", "absolute", "433", "487", "149", "22", null, null, this);
            obj.set_taborder("67");
            obj.set_text("수정자사번");
            obj.set_cssclass("basic_sta_block");
            obj.getSetter("class").set("sta_WADA_label");
            ...
            obj = new Static("Static39", "absolute", "0%", "516", null, "12", "0.2%", null, this);
            obj.set_taborder("71");
            obj.set_text("7");
            obj.set_visible("false");
            obj.style.set_background("#ff000033");
            ...
            obj = new Static("Static04", "absolute", "416", "53", "118", "22", null, null, this);
            obj.set_taborder("72");
            obj.set_text("교육사업관리번호");
            obj.style.set_font("antialias bold 10 Helvetica");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit07", "absolute", "585", "486", "170", "22", null, null, this);
            obj.set_taborder("75");
            obj.set_cssclass("input_must");
            ...
            obj = new Edit("Edit09", "absolute", "158", "410", "270", "22", null, null, this);
            obj.set_taborder("81");
            obj.set_cssclass("input_must");
            obj.style.set_border("2 none #f79a00ff");
            this.addChild(obj.name, obj);

            obj = new Calendar("Calendar00", "absolute", "585", "448", "169", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("90");
            obj.set_dateformat("yyyy.MM.dd");
            obj.set_editformat("yyyy.MM.dd");
            ...
            obj = new Static("Static29", "absolute", "434", "410", "149", "22", null, null, this);
            obj.set_taborder("93");
            ...
            obj = new Edit("Edit03", "absolute", "584", "410", "170", "22", null, null, this);
            obj.set_taborder("94");
            obj.set_cssclass("input_must");
            this.addChild(obj.name, obj);

            obj = new Static("Static18", "absolute", "6", "409", "150", "22", null, null, this);
            obj.set_taborder("95");
            obj.set_text("교육편성일련번호");
            obj.set_usedecorate("true");
            obj.set_cssclass("basic_sta_block");
            ...
            obj = new Calendar("Calendar01", "absolute", "158", "446", "169", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("96");
            obj.set_dateformat("yyyy.MM.dd");
            obj.set_editformat("yyyy.MM.dd");
        ...
        // User Script
        this.addIncludeScript("FrmtnCourse0001.xfdl", "Lib::Comm.xjs");
        this.registerScript("FrmtnCourse0001.xfdl", function(exports) {
        /***********************************************************************************
        * SYSTEM      : 넥사크로플랫폼 
        * BUSINESS    : 샘플화면-교육용
        * FILE NAME   : 
        ...
        ***********************************************************************/
        ...
        this.Calendar01_oneditclick = function(obj,e)
        {
        ...
        this.loadIncludeScript("FrmtnCourse0001.xfdl", true);
