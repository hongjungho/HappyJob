(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stNm", "absolute", null, "1", "157", "29", "152", null, this);
            obj.set_taborder("2");
            ...
            obj = new ImageViewer("ImageViewer00", "absolute", "0%", "0", null, "40", "72.27%", null, this);
            obj.set_taborder("5");
            obj.set_text("ImageViewer00");
            obj.set_image("URL('theme://images/icon.png')");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("TopFrameLibrary.xfdl", "Lib::Comm.xjs");
        this.registerScript("TopFrameLibrary.xfdl", function(exports) {
        /********************************************************************************
         * Name			: TopFrame.xfdl
         * Title		: 상단화면
        ...
        *=============================================================================*/
        ...
        this.loadIncludeScript("TopFrameLibrary.xfdl", true);
