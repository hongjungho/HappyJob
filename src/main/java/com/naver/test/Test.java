...
public class Test {
	 public static void main(String[] args) throws IOException {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=htwrvwhhNHbvyVjiDLPBpyzpGwi0gyFXWAEDtocOpY1Auq6fqPM0wPvpIk3TMTawn5cdaCzRWXrNuIIa4QClsw%3D%3D"); /*Service Key*/
