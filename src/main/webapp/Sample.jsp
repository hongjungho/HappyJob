...
<script src="/edu/resources/jquery-1.11.0.min.js"></script>
<html>
<head>
...
function goPopup(){
	...
	var pop = window.open("/crudexample/jusoPopup.jsp","pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
...
function jusoCallBack(roadFullAddr,roadAddrPart1,addrDetail,jibunAddr,zipNo){
...
<form name="form" id="form" method="post">
	...
	<input type="button" onClick="goNexa();" value="확인toNexa"/>
</form>
</body>
</html>