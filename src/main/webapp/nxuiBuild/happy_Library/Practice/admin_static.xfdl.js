(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("admin_static.xfdl", "Lib::Comm.xjs");
        this.registerScript("admin_static.xfdl", function(exports) {
        ...
        this.loadIncludeScript("admin_static.xfdl", true);
