(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.Div.addChild(obj.name, obj);
            obj = new Static("Static04", "absolute", "200", "410", "599", "35", null, null, this.Div);
            obj.set_taborder("8");
            ...
            this.addChild(obj.name, obj);
            obj = new Button("btn_FindPWD", "absolute", "190", "171", "89", "34", null, null, this.Div00);
            obj.set_taborder("12");
            obj.set_text("비밀번호찾기");
            ...
            obj = new Button("btn_login1", "absolute", "302", "171", "89", "34", null, null, this.Div00);
            obj.set_taborder("13");
            obj.set_text("로그인 화면");
            obj.set_cssclass("WF_btn_Login");
            obj.style.set_color("#808080ff");
            obj.style.set_font("bold 9 Dotum");
            this.Div00.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "50", "18", "454", "29", null, null, this.Div00);
            obj.set_taborder("17");
            obj.set_text("아이디 찾기를 위한 인증 방법을 선택하시기 바랍니다.");
            obj.style.set_font("11 Dotum");
            this.Div00.addChild(obj.name, obj);
            obj = new Button("find_ID_email", "absolute", "50", "60", "500", "34", null, null, this.Div00);
            obj.set_taborder("18");
            obj.set_text("등록된 Email로 찾기");
            obj.style.set_background("#333300ff");
            obj.style.set_border("1 solid #333300ff");
            obj.style.set_color("#ff6600ff");
            obj.style.set_font("bold 9 Dotum");
            this.Div00.addChild(obj.name, obj);
            obj = new Button("find_ID_tel", "absolute", "50", "108", "500", "34", null, null, this.Div00);
            obj.set_taborder("19");
            obj.set_text("등록된 핸드폰번호로 찾기");
            obj.style.set_background("#333300ff");
            obj.style.set_border("1 solid #333300ff");
            obj.style.set_color("#ff6600ff");
            obj.style.set_font("bold 9 Dotum");
        ...
        // User Script
        this.addIncludeScript("find_ID_ans.xfdl", "Lib::Comm.xjs");
        this.registerScript("find_ID_ans.xfdl", function(exports) {
        /***********************************************************************************
        * SYSTEM      : UserProject
        ...
        */
        this.Div00_find_ID_email_onclick = function(obj,e)
        {
        	var sURL = "Practice::find_ID_email.xfdl";
            this.gfn_main(sURL);
        }

        this.Div00_find_ID_tel_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.Static01.addEventHandler("onclick", this.Div_Static03_onclick, this);
            this.Div00.find_ID_email.addEventHandler("onclick", this.Div00_find_ID_email_onclick, this);
            this.Div00.find_ID_tel.addEventHandler("onclick", this.Div00_find_ID_tel_onclick, this);

        };

        this.loadIncludeScript("find_ID_ans.xfdl", true);
