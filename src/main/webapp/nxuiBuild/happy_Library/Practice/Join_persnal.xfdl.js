(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div00", "absolute", "0%", "0", null, "1062", "0%", null, this);
            obj.set_taborder("0");
            ...
            obj = new Div("Div02", "absolute", "16.02%", "678", null, "178", "18.85%", null, this);
            obj.set_taborder("7");
            obj.set_text("Div01");
            obj.style.set_border("1 solid #ffffffff");
            this.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "1.65%", "15", null, "22", "59.1%", null, this.Div02);
            obj.set_taborder("16");
            ...
            obj = new Static("Static01", "absolute", "34.59%", "15", null, "22", "37.14%", null, this.Div02);
            obj.set_taborder("17");
            obj.set_text("고객만족도조사, 설문조사 활용");
            this.Div02.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "1.65%", "37", null, "22", "59.1%", null, this.Div02);
            obj.set_taborder("18");
            ...
            obj.style.set_font("bold 9 Dotum");
            this.Div02.addChild(obj.name, obj);
            obj = new Static("Static03", "absolute", "1.65%", "59", null, "22", "52.63%", null, this.Div02);
            obj.set_taborder("19");
            obj.set_text("- 필수정보 : 아이디, 생년월일, 성별, 휴대전화번호");
            this.Div02.addChild(obj.name, obj);
            obj = new Static("Static04", "absolute", "1.65%", "81", null, "22", "52.63%", null, this.Div02);
            obj.set_taborder("20");
            obj.set_text("- 선택정보 : 대출증번호, 연락처, 이메일");
            this.Div02.addChild(obj.name, obj);
            obj = new Static("Static05", "absolute", "1.65%", "103", null, "22", "59.1%", null, this.Div02);
            obj.set_taborder("21");
            ...
            obj.style.set_font("bold 9 Dotum");
            this.Div02.addChild(obj.name, obj);
            obj = new Static("Static06", "absolute", "34.59%", "103", null, "22", "37.14%", null, this.Div02);
            obj.set_taborder("22");
            obj.set_text("5년");
            this.Div02.addChild(obj.name, obj);
            obj = new Static("Static07", "absolute", "1.65%", "125", null, "43", "0.3%", null, this.Div02);
            obj.set_taborder("23");
            ...
            obj = new Div("Div03", "absolute", "15.14%", "898", "702", "27", null, null, this);
            obj.set_taborder("9");
            obj.style.set_border("1 solid #000000ff");
            this.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "0%", "0", null, "25", "72%", null, this.Div03);
            obj.set_taborder("4");
            obj.set_text("선택사항");
            obj.style.set_background("#e6e6e6ff");
            obj.style.set_border("1 solid #000000ff");
            ...
            obj = new Radio("Radio00", "absolute", "38.29%", "3", null, "20", "16.43%", null, this.Div03);
            this.Div03.addChild(obj.name, obj);
            obj.set_taborder("5");
            obj.set_rowcount("1");
            ...
            obj.style.set_border("1 solid #339966ff");
            this.Div01.addChild(obj.name, obj);
            obj = new Combo("cmb_year", "absolute", "0.55%", "5", null, "20", "86.13%", null, this.Div01.Div06);
            ...
            obj = new Static("Static00", "absolute", "14.42%", "4", null, "22", "80.47%", null, this.Div01.Div06);
            obj.set_taborder("16");
            obj.set_text("년");
            this.Div01.Div06.addChild(obj.name, obj);
            obj = new Combo("cmb_year00", "absolute", "20.07%", "5", null, "20", "69.34%", null, this.Div01.Div06);
            this.Div01.Div06.addChild(obj.name, obj);
            obj.set_taborder("17");
            obj.set_innerdataset("@ds_year");
            obj.set_codecolumn("code");
            obj.set_datacolumn("value");
            obj = new Static("Static01", "absolute", "31.39%", "4", null, "22", "64.78%", null, this.Div01.Div06);
            obj.set_taborder("18");
            obj.set_text("월");
            this.Div01.Div06.addChild(obj.name, obj);
            obj = new Combo("cmb_year01", "absolute", "36.13%", "5", null, "20", "53.28%", null, this.Div01.Div06);
            this.Div01.Div06.addChild(obj.name, obj);
            obj.set_taborder("19");
            obj.set_innerdataset("@ds_year");
            obj.set_codecolumn("code");
            obj.set_datacolumn("value");
            obj = new Static("Static02", "absolute", "47.45%", "4", null, "22", "48.72%", null, this.Div01.Div06);
            obj.set_taborder("20");
            obj.set_text("일");
            this.Div01.Div06.addChild(obj.name, obj);
            obj = new Combo("cmb_year02", "absolute", "53.65%", "5", null, "20", "35.77%", null, this.Div01.Div06);
            this.Div01.Div06.addChild(obj.name, obj);
            obj.set_taborder("21");
            ...
            obj = new BindItem("item0","Div01.Div06.cmb_year","value","ds_year","");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","Div01.Div06.cmb_year00","value","ds_year","");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","Div01.Div06.cmb_year01","value","ds_year","");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div01.Div06.cmb_year.addEventHandler("onitemchanged", this.Div00_Div00_Div07_cmb_year_onitemchanged, this);
            this.Div01.Div06.cmb_year00.addEventHandler("onitemchanged", this.Div00_Div00_Div07_cmb_year_onitemchanged, this);
            this.Div01.Div06.cmb_year01.addEventHandler("onitemchanged", this.Div00_Div00_Div07_cmb_year_onitemchanged, this);
            this.Div01.Div06.Static02.addEventHandler("onclick", this.Div00_Div00_Div06_Static02_onclick, this);
            this.Div01.Div06.cmb_year02.addEventHandler("onitemchanged", this.Div00_Div00_Div07_cmb_year_onitemchanged, this);

        };

        this.loadIncludeScript("Join_persnal.xfdl", true);
