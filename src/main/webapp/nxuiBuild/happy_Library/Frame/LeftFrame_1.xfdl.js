(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("4");
            obj.set_text("Div01");
            obj.style.set_background("#00ccffff");
            this.div_left.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 200, 215, this.div_left.Div01,
            	...
            	function(p) {
            		p.set_taborder("4");
            		p.set_text("Div01");
            		p.style.set_background("#00ccffff");
        ...
        // User Script
        this.addIncludeScript("LeftFrame_1.xfdl", "Lib::Comm.xjs");
        this.registerScript("LeftFrame_1.xfdl", function(exports) {
        ...
        this.loadIncludeScript("LeftFrame_1.xfdl", true);
