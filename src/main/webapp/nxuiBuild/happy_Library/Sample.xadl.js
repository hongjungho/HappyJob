(function()
{
    return function()
    {
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            frame0.set_separatesize("52");

            
            var frame1 = new ChildFrame("ChildFrame0", "absolute", null, null, null, null, null, null, "Frame::TopFrameLib.xfdl", frame0);
            frame0.addChild(frame1.name, frame1);
            frame1.set_showstatusbar("false");
            frame1.set_formurl("Frame::TopFrameLib.xfdl");
            frame1.set_showtitlebar("false");
            frame1.set_showtitleicon("false");
            frame1.set_dragmovetype("none");
            var frame2 = new VFrameSet("VFrameSet1", "absolute", null, null, null, null, null, null, frame0);
            frame0.addChild(frame2.name, frame2);
            frame2.set_separatesize("50");

            
            var frame3 = new ChildFrame("ChildFrame1", "absolute", null, null, null, null, null, null, "Frame::MenuBar.xfdl", frame2);
            frame2.addChild(frame3.name, frame3);
            frame3.set_formurl("Frame::MenuBar.xfdl");
            frame3.set_dragmovetype("none");
            frame3.set_showtitlebar("false");
            frame3.set_showtitleicon("false");
            var frame4 = new HFrameSet("HFrameSet0", "absolute", null, null, null, null, null, null, frame2);
            frame2.addChild(frame4.name, frame4);
            frame4.set_separatesize("200");

            
            var frame5 = new ChildFrame("ChildFrame2", "absolute", null, null, null, null, null, null, "Frame::LeftFrame.xfdl", frame4);
            ...
            frame5.set_formurl("Frame::LeftFrame.xfdl");

            var frame6 = new ChildFrame("ChildFrame3", "absolute", null, null, null, null, null, null, "", frame4);
        ...
        {
            this.addEventHandler("onload", this.fn_test, this);
