...
if (!JsNamespace.exist("Iject"))
{
	...
	JsNamespace.declare("Iject", {
		...
		appOnload : function(o)
		{
			...
			Iject.$["loginSize"]      = {width:480,height:390};
		...
		setSeprateFrame : function()
		{
			...
			//**** 임시 필요에따라 삭제해서 사용
			Iject.$["userid"] = application.gds_userInfo.getColumn(0,"userId");
			Iject.$["usernm"] = application.gds_userInfo.getColumn(0,"userNm");
		...
		*/
		 transaction : function(o,oData,callback)
		{
			...
			var oSvc 	           = {oform:pThis};
				...
				oSvc["svcId"]      = oData.svcid; //service id
